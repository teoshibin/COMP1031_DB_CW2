...
if(isset($_POST['submit'])){
    ...
    try{
        ...
        //#2 Prepare Sql QUery 
        $statement = $connection->prepare("INSERT INTO payment (customer_id,staff_id,rental_id,amount,payment_date,last_update) 
        VALUES (?,?,?,?,NOW(),NOW()) ");

        $statement ->bindParam(1,$_POST['customer_id'],PDO::PARAM_INT);
        $statement ->bindParam(2,$_POST['staff_id'],PDO::PARAM_INT);
        $statement ->bindParam(3,$_POST['rental_id'],PDO::PARAM_INT);
        $statement ->bindParam(4,$_POST['amount'],PDO::PARAM_INT);
