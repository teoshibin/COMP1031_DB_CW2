...
<head>
    ...
    <script type="text/javascript" src="country_valid.js"></script>
</head>

<div class="content">
    <h3 class="title">New Country</h3>
    <form name="myform" action="country_add.inc.php" onsubmit="return validateForm()" method="post">
        ...
        <a href="country.php" class="btn-back">BACK</a>
