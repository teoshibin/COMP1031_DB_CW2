                ...
                <?php foreach ($result as $row) : ?>
                    <tr class="tr-back">
                        ...
                        <td align="left">
                            ...
                            <a type="buttons" class="btn" name="delete" type="submit" href="inventory.php?id=<?php echo escape($row["inventory_id"]); ?>" onClick='return confirm("Are you sure want to delete inventory id <?php echo escape($row["inventory_id"]); ?>?");'>
