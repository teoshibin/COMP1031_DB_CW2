...
function validateForm() {
    ...
    if(description == '') {
        ...
        error_msg+=("Please insert the description about this film\n");
    ...
    if(release_year == '') {
        ...
        error_msg+=("Please insert the film's release year\n");
    ...
    if(length == '') {
        ...
        error_msg+=("Please insert the film's length\n");
    ...
    if(( titleErr || descriptionErr || release_yearErr || language_idErr || rental_durationErr || rental_rateErr || lengthErr || replacement_costErr || ratingErr || special_featuresErr) == true) {
